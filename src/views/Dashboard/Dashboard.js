            ...
            <Row>
                        ...
                        <CardBody className="pb-0">
                            <ButtonGroup className="float-right">
                                <ButtonDropdown id='card1' isOpen={this.state.card1} toggle={() => {
                                    ...
                                    <DropdownToggle caret="caret" className="p-0" color="transparent">
                                        <i className="icon-settings"></i>
                                    </DropdownToggle>
                                    <DropdownMenu right="right">
                                        <DropdownItem>Action</DropdownItem>
                                        <DropdownItem>Another action</DropdownItem>
                                        <DropdownItem disabled="disabled">Disabled action</DropdownItem>
                ...
                <Col xs="12" sm="6" lg="3">
                    <Card className="text-white bg-warning">
                        ...
                        <div className="chart-wrapper px-0" style={{
                                height: '70px'
                            }}>
                                    ...
                                    <ButtonToolbar className="float-right" aria-label="Toolbar with button groups">
                                        <ButtonGroup className="mr-3" data-toggle="buttons" aria-label="First group">
                                            ...
                                            <Label htmlFor="option2" className="btn btn-outline-secondary active">
                                                <Input type="radio" name="options" id="option2" defaultChecked="defaultChecked"/>
                                                Month
                                            </Label>
                ...
                <Col>
                    <Card>
                        ...
                        <CardBody>
                            <Row>
                                <Col xs="12" md="6" xl="4">
                                    ...
                                    <ul className="horizontal-bars">
                                        ...
                                        <li className="legend">
                                            <Badge pill="pill" color="info"></Badge>
                                            <small>New clients</small>
                                            &nbsp;
                                            <Badge pill="pill" color="danger"></Badge>
                            ...
                            <br/>
                            <Table hover="hover" responsive="responsive" className="table-outline mb-0 d-none d-sm-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td className="text-center">
                                            <img src={'img/flags/Brazil.png'} alt="Brazil" style={{
                                                    height: 24 + 'px'
                                                }}/>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td className="text-center">
                                            <img src={'img/flags/India.png'} alt="India" style={{
                                                    height: 24 + 'px'
                                                }}/>
                                        </td>
                                        <td>
                                        ...
                                        <td className="text-center">
                                            <i className="fa fa-cc-stripe" style={{
                                                    fontSize: 24 + 'px'
                                                }}></i>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td className="text-center">
                                            <img src={'img/flags/France.png'} alt="France" style={{
                                                    height: 24 + 'px'
                                                }}/>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td className="text-center">
                                            <img src={'img/flags/Spain.png'} alt="Spain" style={{
                                                    height: 24 + 'px'
                                                }}/>
                                        </td>
                                        <td>
                                        ...
                                        <td className="text-center">
                                            <i className="fa fa-google-wallet" style={{
                                                    fontSize: 24 + 'px'
                                                }}></i>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td className="text-center">
                                            <img src={'img/flags/Poland.png'} alt="Poland" style={{
                                                    height: 24 + 'px'
                                                }}/>
                                        </td>
                                        <td>
