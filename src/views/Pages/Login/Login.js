                        ...
                        <CardGroup className="mb-0">
                            <Card className="p-4">
                                <CardBody>
                                    ...
                                    <Row>
                                        <Col xs="6">
                                            <Button color="primary" className="px-4" onClick={this.handleLogin.bind(this)} disabled={fetching}>Login</Button>
                                        </Col>
                            ...
                            <Card className="text-white bg-primary py-5 d-md-down-none" style={{
                                ...
                                <CardBody className="text-center">
                                    <div>
                                        ...
                                        <Link to="/register">
                                            <Button color="primary" className="mt-3" active="active">Register Now!</Button>
                                        </Link>
                                    </div>
                                </CardBody>
                            </Card>
