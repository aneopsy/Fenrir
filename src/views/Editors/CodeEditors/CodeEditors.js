    ...
    return (
      <Card>
        ...
        <CardFooter>
          <Form inline>
            <FormGroup>
                <Input type="select" size="sm" name="theme" id="theme" onChange={(e) => this.changeTheme(e)} value={this.state.theme} >
                  <option value="material">material</option>
                  <option value="eclipse">eclipse</option>
                </Input>
            </FormGroup>
            <FormGroup>
                <Input type="select" size="sm" name="mode" id="mode" onChange={(e) => this.changeMode(e)} value={this.state.mode} >
