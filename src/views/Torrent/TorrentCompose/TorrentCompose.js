...
class TorrentCompose extends Component {
    render() {
        return (<div className="animated fadeIn">
            <div className="email-app">
                    ...
                    <ul className="nav">
                        ...
                        <li className="nav-item">
                            <a className="nav-link" href="#">
                                ...
                                Important<span className="badge badge-info">5</span>
                            </a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link" href="#">
                ...
                <main>
                    <p className="text-center">New Torrent</p>
                    <form>
